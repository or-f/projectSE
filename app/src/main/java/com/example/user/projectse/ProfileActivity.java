...
public class ProfileActivity extends AppCompatActivity {
    ...
    EditText name_, univercity_,dep_, age_, email_;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userProfile = new ProfileHelper(this);
        ...
        if( fab != null){
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Student student = new Student(name_.getText().toString(),univercity_.getText().toString(),dep_.getText().toString(),age2,email_.getText().toString());
                    Toast.makeText(context, " Name: " + student.name + " loction: " + student.univercity + " type: " + student.deparpment + " Date: " + student.age, Toast.LENGTH_LONG).show();
        ...
        univercity_ = (EditText)findViewById(R.id.stdInstitude);
